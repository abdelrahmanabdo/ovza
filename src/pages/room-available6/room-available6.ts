import {RoomAvailable7Page} from './../room-available7/room-available7';
...
@Component({
  selector: 'page-room-available6',
  templateUrl: 'room-available6.html',
})
export class RoomAvailable6Page {
  ...
  room_available() {
    ...
    if (!isEmpty(this.room)) {
      if(checkfalse(this.room)){
        this.navCtrl.push(RoomAvailable7Page, data);
      }else{
        this.room = {} ;
      }
