import {RoomAvailable5Page} from './../room-available5/room-available5';
...
@Component({
  selector: 'page-room-available4',
  templateUrl: 'room-available4.html',
})
export class RoomAvailable4Page {
  ...
  room_available() {
    ...
    if (!isEmpty(this.room)) {
      if(checkfalse(this.room)){
        this.navCtrl.push(RoomAvailable5Page, data);
      }else{
        this.room = {} ;
      }
